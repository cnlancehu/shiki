...
pub use highlighter::{
    ...
    LanguageSession, ResolvedStyle, ThemeInfo, split_lines,
};
...
pub use tokenizer::{
    GrammarState, MultiThemedToken, RegexCacheStats, RegexLimits, ScopeStackId,
    ScopeToken, ThemeId, ThemeTokenStyle, ThemedToken, TokenizerCacheStats,
};
